...
def get_competitor_data(store_id, filters={}):
	...
	query = """SELECT prod.sku, cs.id "csid", p.store_name AS "Comp", p.price AS "Comp Price", p.ship AS "Comp Shipping", p.url AS "Comp URL", prod.competitors_count AS "Total Competitors"
				FROM products AS prod
